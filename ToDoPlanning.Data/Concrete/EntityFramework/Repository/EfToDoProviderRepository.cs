...
{
    public class EfToDoProviderRepository : EfEntityRepositoryBase<ToDoProvider>, IToDoProviderRepository
    {
        public EfToDoProviderRepository(DbContext context) : base(context)
        {
        }
    }
}
